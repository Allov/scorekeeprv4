...
import CreateGameName from './pages/CreateGameName'
...
function App() {
  ...
  return (
    <div className="w-full bg-slate-100 dark:bg-slate-100 flex flex-col justify-start items-center">
      <header className="top-0 z-50 h-20 w-full pl-5 flex items-center border-b-2 bg-gradient-to-t from-slate-200 to-white drop-shadow-md">
      ...
      <AnimatePresence exitBeforeEnter>
        <Routes location={location} key={location.pathname}>
          ...
          <Route path="/create-game" element={<CreateGameName />} />
